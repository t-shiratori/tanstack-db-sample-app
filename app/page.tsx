					...
					<div className="max-w-3xl mx-auto">
						...
						<div className="mt-8 p-6 bg-blue-50 rounded-lg border border-blue-200">
							...
							<ul className="text-sm text-blue-800 space-y-1">
								...
								<li>
									• <strong>Live Queries:</strong> Reactive queries with
									filtering and sorting (see TodoList.tsx)
								</li>
								<li>
									• <strong>Optimistic Mutations:</strong> Instant UI updates
									with background sync (see TodoItem.tsx)
								</li>
								<li>
									• <strong>Error Handling:</strong> Toggle error simulation
									mode to see optimistic updates automatically rollback on
									server errors
								</li>
							</ul>
						</div>
